...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _devBundle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./devBundle */ \"./server/devBundle.js\");\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! path */ \"path\");\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../template */ \"./template.js\");\n/* harmony import */ var mongodb__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! mongodb */ \"mongodb\");\n/* harmony import */ var mongodb__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(mongodb__WEBPACK_IMPORTED_MODULE_4__);\n/* module decorator */ module = __webpack_require__.hmd(module);\n(function () {\n  var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;\n  enterModule && enterModule(module);\n})();\n\nvar __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {\n  return a;\n};\n\n\n // for development only\n\n // added to make the static files available in client side\n\n // template to be rendered from /\n\n\nconst CURRENT_WORKING_DIR = process.cwd(); // const url = process.env.MONGODB_URL || 'mongodb://localhost:27017/mernSimpleSetup'\n// MongoClient.connect(url, (err, db) => {\n//     console.log(\"Connected successfully to mongodb server\")\n//     db.close()\n// }) // Mongo client\n\nlet port = process.env.PORT || 3000;\nconst app = express__WEBPACK_IMPORTED_MODULE_0__(); // Node server application\n\n_devBundle__WEBPACK_IMPORTED_MODULE_1__[\"default\"].compile(app); // for development only, will be ompiled by webpack to dist/bundle.js\n\napp.use('/dist', express__WEBPACK_IMPORTED_MODULE_0__[\"static\"](path__WEBPACK_IMPORTED_MODULE_2___default().join(CURRENT_WORKING_DIR))); // configures express appp to return the static files from /dist when request starts with /dist\n\napp.get('/', (req, res) => {\n  res.status(200).send((0,_template__WEBPACK_IMPORTED_MODULE_3__[\"default\"])());\n});\napp.listen(port, function onStart(err) {\n  if (err) {\n    console.log(err);\n  }\n\n  console.log('Server started on port %s', port);\n});\n;\n\n(function () {\n  var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(CURRENT_WORKING_DIR, \"CURRENT_WORKING_DIR\", \"/home/mfadhili/Software/nodejs/mern-simplesetup/server/server.js\");\n  reactHotLoader.register(port, \"port\", \"/home/mfadhili/Software/nodejs/mern-simplesetup/server/server.js\");\n  reactHotLoader.register(app, \"app\", \"/home/mfadhili/Software/nodejs/mern-simplesetup/server/server.js\");\n})();\n\n;\n\n(function () {\n  var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;\n  leaveModule && leaveModule(module);\n})();\n\n//# sourceURL=webpack://mern-simplesetup/./server/server.js?");
...
eval("/* module decorator */ module = __webpack_require__.nmd(module);\n(function () {\n  var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;\n  enterModule && enterModule(module);\n})();\n\nvar __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {\n  return a;\n};\n\nconst path = __webpack_require__(/*! path */ \"path\");\n\nconst webpack = __webpack_require__(/*! webpack */ \"webpack\");\n\nconst CURRENT_WORKING_DIR = process.cwd();\nconst config = {\n  name: \"browser\",\n  mode: \"development\",\n  // e sets process.env.NODE_ENV default is production\n  devtool: 'eval-source-map',\n  //generating source maop\n  entry: ['webpack-hot-middleware/client?reload=true', path.join(CURRENT_WORKING_DIR, 'client/main.js')],\n  //where entry file starts bundling  ie main.js\n  output: {\n    path: path.join(CURRENT_WORKING_DIR, '/dist'),\n    // outpit bundled code\n    filename: 'bundle.js',\n    publicPath: '/dist/' // path for app assets\n\n  },\n  module: {\n    rules: [{\n      test: /\\.jsx?$/,\n      exclude: /node_modules/,\n      use: ['babel-loader'] // transpilation tool \n\n    }]\n  },\n  plugins: [new webpack.HotModuleReplacementPlugin(), //enables hot module replacemen\n  new webpack.NoEmitOnErrorsPlugin() // skipping emitting on errors\n  ],\n  resolve: {\n    alias: {\n      'react-dom': '@hot-loader/react-dom' // add a Webpack alias to point react-dom\n\n    }\n  }\n};\nmodule.exports = config;\n;\n\n(function () {\n  var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(CURRENT_WORKING_DIR, \"CURRENT_WORKING_DIR\", \"/home/mfadhili/Software/nodejs/mern-simplesetup/webpack.config.client.js\");\n  reactHotLoader.register(config, \"config\", \"/home/mfadhili/Software/nodejs/mern-simplesetup/webpack.config.client.js\");\n})();\n\n;\n\n(function () {\n  var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;\n  leaveModule && leaveModule(module);\n})();\n\n//# sourceURL=webpack://mern-simplesetup/./webpack.config.client.js?");
